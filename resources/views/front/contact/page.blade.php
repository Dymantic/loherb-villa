...
@section('content')
    <div class="bg-green-soft px-4 pt-24 pb-12">
        <div class="max-w-md mx-auto flex flex-col items-center">
            <p class="heading-text mb-4 text-green-main">Get in Touch</p>
            <span>
                @include('svgs.logos.leaf')
            </span>
            <p class="my-8 body-text text-green-main">Please feel free to get in touch with any questions about Loherb Villa.</p>
        </div>
    </div>
