<div class="fixed pin-t w-full flex justify-between items-center h-12 px-4 main-nav bg-green-main md:bg-transparent hover:bg-green-main">
    <div>
    ...
    <nav class="flex justify-end items-stretch font-sans h-12 nav-list bg-green-main md:bg-transparent">
        ...
        <div class="flex items-start md:items-center rooms-nav" tabindex="3">
            ...
            <div class="room-nav-sub mt-4 md:mt-0 bg-green-soft absolute w-screen flex flex-col md:flex-row justify-center">
                <div class="pl-4 md:pl-0 mx-0 md:mx-12 my-0 md:my-4 flex justify-start md:items-center flex-col text-green-main">
                    <p class="uppercase mb-3 border-b border-green-mid tracking-wide hidden md:block">Economy</p>
                ...
                <div class="pl-4 md:pl-0 mx-0 md:mx-12 my-0 md:my-4 flex justify-start md:items-center flex-col text-green-main">
                    <p class="uppercase mb-3 border-b border-green-mid tracking-wide hidden md:block">Luxury</p>
                ...
                <div class="pl-4 md:pl-0 mx-0 md:mx-12 my-0 md:my-4 flex justify-start md:items-center flex-col text-green-main">
                    <p class="uppercase mb-3 border-b border-green-mid tracking-wide hidden md:block">VIP</p>
                ...
                <div class="pl-4 md:pl-0 mx-0 md:mx-12 my-0 md:my-4 flex justify-start md:items-center flex-col text-green-main">
                    <p class="uppercase mb-3 border-b border-green-mid tracking-wide hidden md:block">Villa</p>
