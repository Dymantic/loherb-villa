<div class="flex flex-col md:flex-row relative w-full my-20 {{ $side === 'right' ? 'justify-start' : 'justify-end' }}">
    ...
    <div class="rounded-sm bg-ivory md:shadow-lg md:w-1/3 md:absolute my-auto md:top-50 md:transform md:-translate-y-1/2 p-4 {{ $side === 'right' ? 'right-0' : 'left-0' }}">
        ...
        @endif
        <p class="type-b1 text-green-main leading-none mt-2">{{ $roomAttribute('intro') }}</p>
